...
namespace Pintushi\Bundle\UserBundle\Autocomplete;

use Doctrine\ORM\EntityManager;
use Doctrine\ORM\Query;
use Doctrine\ORM\QueryBuilder;
use Pintushi\Bundle\EntityBundle\Provider\EntityNameResolver;
use Pintushi\Bundle\EntityBundle\Tools\EntityClassNameHelper;
...
use Pintushi\Bundle\SecurityBundle\ORM\Walker\OwnershipConditionDataBuilder;
...
class UserAclHandler implements SearchHandlerInterface
{
    ...
    {
        return $this->em->getRepository($this->className)->findBy(['id' => explode(',', $query)]);
    }
